...
MissionRegObject( Misc, "Octagon", MissionCreateObject, elevator16x16_octo, StaticShape, Octagon);
...
exec(Server::detVerAp("registerworld.cs"));
exec(Server::detVerAp("registerUserObjects.cs"));
