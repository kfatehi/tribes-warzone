//----------------------------------------------------------------------------
  ...
  $DamageScale[harmor, $CrushDamageType] = 0.01;
  ...
  $ItemMax[harmor, BulletAmmo] = 250;
  $ItemMax[harmor, PlasmaAmmo] = 100;
  $ItemMax[harmor, DiscAmmo] = 100;
  $ItemMax[harmor, GrenadeAmmo] = 175;
  $ItemMax[harmor, MortarAmmo] = 200;
