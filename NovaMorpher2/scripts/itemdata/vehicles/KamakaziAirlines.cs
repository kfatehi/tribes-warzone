...
ItemData KamakaziPlane
{
	description = "Kamakazi Jet";
	className = "Vehicle";
	heading = "aVehicle";
	price = 3251;
};

$TeamItemMax[KamakaziPlane] = 2;

$VehicleInvList[KamakaziPlane] = 1;
$DataBlockName[KamakaziPlane] = KamakaziJet;
$VehicleToItem[KamakaziJet] = KamakaziPlane;