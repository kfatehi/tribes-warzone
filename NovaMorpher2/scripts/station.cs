...
//== Basic Armors ==//
//==              ==//
$InvList[LightArmor] = 1;
$InvList[MediumArmor] = 1;
$InvList[HeavyArmor] = 1;
//----------------------------------------------------------------------------
...
function Station::itemsToResupply(%player)
{
	...
	%cnt = %cnt + AmmoStation::resupply(%player,RocketLauncher,RocketAmmo,2);

	%cnt = Patch::Resupply(%player,%cnt);
